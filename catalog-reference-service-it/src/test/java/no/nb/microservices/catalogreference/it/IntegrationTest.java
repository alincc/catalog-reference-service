...
public class IntegrationTest {
    ...
    public void setup() throws Exception {
        ...
        final Dispatcher dispatcher = new Dispatcher() {
            ...
            public MockResponse dispatch(RecordedRequest recordedRequest) throws InterruptedException {
                if (recordedRequest.getPath().equals("/catalog/v1/items/41a7fb4e94aab9a88be23745a1504a92")) {
                    return new MockResponse().setBody(item1).setResponseCode(200).setHeader("Content-Type", "application/hal+json; charset=utf-8");
                } else if (recordedRequest.getPath().equals("/catalog/v1/items/abcdef1234567890abcdef1234567890")) {
    ...
    public void testCreateWikibookReference() {
        ResponseEntity<String> entity = restTemplate.getForEntity("http://localhost:" + port + "/catalog/v1/reference/41a7fb4e94aab9a88be23745a1504a92/wiki", String.class);
    ...
    public void testCreateWikifilmReference() {
        ResponseEntity<String> entity = restTemplate.getForEntity("http://localhost:" + port + "/catalog/v1/reference/abcdef1234567890abcdef1234567890/wiki", String.class);
        assertEquals(HttpStatus.OK, entity.getStatusCode());
        assertNotNull(entity.getBody());
    }
    ...
    public void testCreateRISReference() throws Exception {
        URI uri = new URI("http://localhost:" + port + "/catalog/v1/reference/41a7fb4e94aab9a88be23745a1504a92/ris");
    ...
    public void testCreateENWReference() throws Exception {
        URI uri = new URI("http://localhost:" + port + "/catalog/v1/reference/41a7fb4e94aab9a88be23745a1504a92/enw");
        ResponseEntity<ByteArrayResource> entity = restTemplate.getForEntity(uri, ByteArrayResource.class);
        assertEquals(HttpStatus.OK, entity.getStatusCode());
    }
